...
export const OrthoSpinePageComponent: CollectionConfig = {
  slug: 'ortho-spine-page-component',
  admin: {
  ...
  fields: [
    {
      ...
      type: 'text',
      required: true,
      defaultValue: 'Ortho & Spine Lake Mary — Page Component',
    },
    ...
    /* ---------------- Top notice strip ---------------- */
    {
      ...
      fields: [
        ...
        { name: 'accentColor', type: 'text', defaultValue: '#C2922F' },
        {
          ...
          defaultValue: [
            { boldText: 'Self-pay clinic.', text: 'We do not bill insurance.' },
            { text: 'Flat pricing quoted before anything is done' },
            { text: 'No prior authorization, no surprise bills' },
          ],
        },
      ],
    },
    ...
    /* ---------------- Header ---------------- */
    {
      ...
      label: 'Header',
      fields: [
        { name: 'brandWordOne', type: 'text', defaultValue: 'Ortho' },
        { name: 'brandWordOneColor', type: 'text', defaultValue: '#2C3742' },
        { name: 'brandWordTwo', type: 'text', defaultValue: '&Spine' },
        { name: 'brandWordTwoColor', type: 'text', defaultValue: '#8F5A14' },
        { name: 'brandSub', type: 'text', defaultValue: 'Physician Group · Lake Mary' },
          ...
          fields: [
            ...
            statsArray([
              ...
              },
              {
                number: 'Self-pay',
                label:
                  'No insurance billing, no prior authorization — one flat price, quoted up front',
              },
            ]),
          ],
        },
        ...
        },
        {
          ...
          fields: [
            ...
            { name: 'eyebrow', type: 'text', defaultValue: 'Payment' },
            {
              name: 'heading',
              type: 'text',
              defaultValue: "We don't take insurance. Here's why that's good for you.",
            },
            richBlank('lede', 'Lede'),
            cardsArray('cards', 'Payment Cards', [
              {
                ...
                description:
                  'One flat fee per visit and per injection, quoted on the phone before you book. No coinsurance math, no deductible surprises, no bill arriving six weeks later.',
              },
              {
                title: 'No prior authorization',
                description:
                  'Nobody at an insurance company decides whether your knee gets treated this week. If the exam says an injection is right and you agree, it happens that visit.',
              },
              {
                title: "Your appointment isn't rationed",
                description:
                  "Without claim volume driving the schedule, visits run on clinical need rather than billing codes. That's why the exam and the injection fit in one appointment.",
              },
            ]),
            {
              name: 'twoColCards',
            ...
            },
            {
              ...
              type: 'textarea',
              defaultValue:
                'We are out of network with all plans, including Medicare and Medicaid. Patients enrolled in Medicare should be aware that services here are not billed to or reimbursed by Medicare. Confirm the current fee for your visit when you call.',
            },
          ],
        },
        {
          ...
          fields: [
            ...
            mediaGroup('portrait', 'Portrait', 'Dr. James Young, DO portrait'),
          ],
        },
        ctaBandGroup('ctaBand', {
          heading: 'Still hurting three weeks later?',
          text: "That's the point where a joint usually needs more than rest and ibuprofen. Call us and describe it — the conversation is free.",
          buttonText: 'Call',
        }),
      ],
    },
          ...
          fields: [
            ...
            dlArray('faqItems', 'FAQ Items', [
              ...
              },
              {
                term: 'Insurance',
                description:
                  "We don't bill insurance. This is a self-pay clinic, out of network with every plan including Medicare.",
              },
              {
                term: 'What it costs',
                description:
    ...
    /* ============================= FOOTER ============================= */
    {
      ...
      fields: [
        ...
        ),
        {
          name: 'copyrightText',
          type: 'text',
          defaultValue: '© [Year] Ortho & Spine Physician Group. All rights reserved.',
        },
        {
          name: 'legalLinks',
          type: 'array',
    ...
    /* ============================= STRUCTURED DATA ============================= */
    {
      ...
      fields: [
        ...
        ]),
        {
          name: 'clinicName',
          type: 'text',
          defaultValue: 'Ortho & Spine Physician Group — Lake Mary',
        },
        { name: 'clinicMedicalSpecialty', type: 'text', defaultValue: 'Orthopedic' },
        {
          name: 'paymentAccepted',
          type: 'text',
          defaultValue: 'Self-pay only; insurance not billed',
        },
      ],
    },
    ...
    /* ============================= SEO ============================= */
    {
      ...
      fields: [
        { name: 'metaTitle', type: 'text', defaultValue: 'Ortho & Spine Lake Mary' },
        {
          ...
          type: 'textarea',
          defaultValue:
            'Ortho & Spine Physician Group — joint, tendon and injury care in Lake Mary, Florida. Self-pay clinic; we do not bill insurance.',
        },
...
export default OrthoSpinePageComponent
